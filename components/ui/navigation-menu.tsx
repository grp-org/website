...
const navigationMenuTriggerStyle = cva(
  "inline-flex items-center border border-transparent hover:border-muted justify-center rounded-md text-sm font-medium transition-colors focus:outline-hidden focus:bg-accent focus:text-accent-foreground disabled:opacity-50 disabled:pointer-events-none hover:bg-accent/50 hover:text-accent-foreground data-[state=open]:bg-accent/50 data-active:bg-accent/50 h-10 py-2 px-4 group w-max",
);
